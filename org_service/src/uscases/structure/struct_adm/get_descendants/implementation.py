...
from .abstract import AbstractGetDescendantsStructAdmUseCase

log = get_logger(__name__)


class PostgreSQLGetDescendantsUseCase(AbstractGetDescendantsStructAdmUseCase):
    ...
    async def execute(self, parent_id: uuid.UUID, company_id: uuid.UUID) -> list[StructAdmDTO]:
        async with self._uow as uow:
            ...
            return await uow.struct_adm.get_descendants(parent_path=parent.path)
